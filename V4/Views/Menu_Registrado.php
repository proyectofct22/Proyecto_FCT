<nav class="navbar navbar-dark bg-dark fixed-top">
	<div class="container-fluid justify-content-start">
		...
		<a class="navbar-brand mx-5" href="./Controller_Perfil_Jugador.php">Gaming Room</a>
		<div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
					...
					<!-- Prueba -->
					<!-- <li class="nav-item"><a class="nav-link ms-2" href="./Controller_Pruebas.php"><i class="bi bi-people-fill"></i>&nbsp;&nbsp;Prueba</a></li> -->
					<!-- Fin Prueba -->
					<li class="nav-item"><a class="nav-link ms-2" href="./Controller_Torneo_Jugador.php"><i class="bi bi-trophy-fill"></i>&nbsp;&nbsp;Torneo</a></li>
					<li class="nav-item"><a class="nav-link ms-2" href="./Controller_Sobre_Nosotros_Jugador.php"><i class="bi bi-info-square-fill"></i>&nbsp;&nbsp;Sobre Nosotros</a></li>
