...
<div class="container py-5 my-5">
	<form method="post" class="form-floating" action="../Usuario_Jugador/Controller_Perfil_Jugador.php" enctype="multipart/form-data">
		<div class="card border-light p-5" style="background:rgba(0,0,0,0.5);">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<?php
						$nombre_fichero = '../../Media/Usuarios/'.$_SESSION['idUsuario'].'.jpg';
						if (file_exists($nombre_fichero)) {
							echo '<img src="'.$nombre_fichero.'" class="img-fluid rounded-2" style="width:300px; height:auto;">';
						} else {
							echo '<img src="../../Media/Usuarios/Default.jpg" class="img-fluid rounded-2" style="object-fit: cover;">';
						}
					?>
					<div class="row gy-2 pt-2">
						<div class="col-lg-6">
							<label class="btn btn-primary w-100">Cambiar<input type="file" name="imagen" hidden></label>
						</div>
						<div class="col-lg-6">
							<input class="btn btn-primary cambiarImagen w-100" type="submit" value="Confirmar" name="cambiarImagen">
						</div>
						<div class="col-lg-12">
							...
							data-bs-content="
								<div class='row text-center'>
									...
									<div class='col'>.jpg</div>
								</div>
								<div class='row text-center'>
									<div class='col'>Tamaño</div>
									<div class='col'>480x480</div>
								</div>
