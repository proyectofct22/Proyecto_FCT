...
<div class="container centrarContenido p-5">
	<div class="card border-light px-5" style="background:rgba(0,0,0,0.5);">
		<div class="row text-center text-white">
			<h1 class="display-4 fuentePersonalizadaRegistrado pt-3"><?php echo $_SESSION['nick']; ?></h1>
			<div class="col-lg-12">
